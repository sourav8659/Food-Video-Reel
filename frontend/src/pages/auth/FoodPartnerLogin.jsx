...
const FoodPartnerLogin = () => {
    ...
    const handleSubmit=async(e) => {
        ...
        const response=await axios.post("http://localhost:3500/api/auth/food-partner/login",{email,password},{ withCredentials: true});   // withCredentials to include cookies
