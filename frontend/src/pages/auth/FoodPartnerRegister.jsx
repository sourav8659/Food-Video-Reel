...
const FoodPartnerRegister = () => {
    ...
    const handleSubmit=(e) => {
        ...
        axios.post("http://localhost:3500/api/auth/food-partner/register",{
            name: businessName,
            contactName,phone,email,password,address
        },{withCredentials: true})    // withCredentials to include cookies
            .then(response => {
